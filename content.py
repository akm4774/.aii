branchContent = {
    "BCA-Artifical Intelligence and Data Analytics (BCA-AIDA)": {
    ...
    "Bachelor of Dental Surgery(BDS)": {
        "content": "The Bachelor of Dental Surgery (BDS) degree program focuses on oral health and dental care. It includes various fields such as anatomy, physiology, pathology, and dental materials. As a BDS student, you will learn about the diagnosis, prevention, and treatment of oral diseases such as tooth decay, periodontal disease, and oral cancer. The curriculum combines theoretical knowledge with practical clinical practice to hone your skills in dental procedures such as fillings, extractions, and root canals A career as a dentist provides the opportunity to improve people's quality of life by improving their oral health and the beauty of their smiles. It is a rewarding profession that requires precision, compassion, and a commitment to lifelong learning.",
        "image": "static/images/BDS.jpg"
    },
    "Bachelor of Medical Laboratory Technology (BMLT)": {
        "content": "Medical laboratory technology (BMLT) is an important field in healthcare. It focuses on analyzing medical samples to aid in the diagnosis, treatment, and prevention of disease. As a BMLT expert, you will learn to operate advanced laboratory equipment, perform tests, and accurately analyze results. This course covers various aspects of clinical chemistry, microbiology, hematology and immunology and prepares you for a career in diagnostic laboratories, hospitals and research institutions. If you have a passion for contributing to patient care behind the scenes, BMLT offers a fulfilling career path. Accuracy, attention to detail, and scientific knowledge play a key role in improving health outcomes.",
        "image": "static/images/BMLT.png"
    },
    "Bachelor of Medicine, Bachelor of Surgery (MBBS)": {
        "content": "A career in MBBS (Bachelor of Medicine, Bachelor of Surgery) programme, is a profound journey of compassion and scientific discovery. The MBBS programme includes in-depth study of human anatomy, physiology, pharmacology, and pathology, preparing you to diagnose, treat, and prevent disorders. It entails rigorous training, practical experience, and a dedication to lifelong learning. As a medical professional, you will have the opportunity to directly affect people's lives by giving care, comfort, and healing. If you're enthusiastic about improving health outcomes, reducing suffering, and making a difference in the world, MBBS is a rewarding route where science and humanity intersect in deep ways.",
    ...
    "Bachelor of Pharmacy (BPHARMA)": {
        ...
        "image": "static/images/Bpharma.png"
    },
    "Bachelor of Physiotherapy (BPT)": {
        "content": "The Bachelor of Physical Therapy program (BPT) focuses on the movement and function of the human body and aims at the prevention, diagnosis, and rehabilitation of physical disorders and disorders. In this course, you will learn anatomy, physiology, biomechanics, and therapeutic techniques to treat a variety of conditions, including sports injuries, neurological disorders, and musculoskeletal problems. BPT offers a rewarding career that allows you to directly impact people's lives by improving their mobility, reducing pain, and improving their quality of life. If you have a passion for helping others recover from injury and regain independence, BPT offers a fulfilling path in the healthcare field.",
        "image": "/static/images/BPT.png"
    },
    ...
    "CSE-Artificial Intelligence and Machine Learning (AIML)": {
        "content": "B.Tech Computer Science and Engineering (Artificial Intelligence and Machine Learning) helps students to design and develop computer-based applications of varying complexities in emerging areas of Artificial Intelligence and Machine Learning.The curriculum primarily focuses on the foundations of computational mathematics, core components of Computer Science, along with the latest advancements in Artificial Intelligence and Machine Learning like Artificial Intelligence, and Neural Networks (NLP),Algorithms and Pattern Recognition,Robotics, Automata, and Deep Learning,Sensors, Computer Vision, and Big Data.",
