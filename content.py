branchContent = {
    ...
    "Nursing": {
        "content": "Nursing is more than a profession; it's a calling to care, comfort, and heal. Nurses are the heartbeat of healthcare, tirelessly advocating for patients and ensuring their well-being with compassion and expertise. From bedside manner to critical decision-making, nurses embody the essence of healthcare's humanity. They are the unsung heroes whose dedication makes a difference in countless lives every day.",
        "image": "/static/images/nursing.jpg"
    },
    "BDS": {
        "content": "A Bachelor of Dental Surgery (BDS) is an undergraduate professional degree program that prepares students for a career in dentistry. Typically, it is a five-year program, though the duration may vary depending on the country and institution. During the BDS program, students receive comprehensive training in various aspects of dentistry, including dental anatomy, oral pathology, radiology, periodontics, endodontics, orthodontics, oral surgery, and restorative dentistry. The curriculum includes both theoretical coursework and practical clinical training, allowing students to develop the necessary knowledge and skills to diagnose, treat, and prevent oral diseases and disorders. Upon completion of the BDS program, graduates are eligible to pursue licensure or registration to practice dentistry in their respective jurisdictions. They may also choose to further their education through specialization or pursue research opportunities in the field of dentistry.",
        "image": "/static/images/BDS.jpg"
    },
    "BPT": {
        "content": "A Bachelor of Physiotherapy (BPT) is an undergraduate degree program that prepares students for a career in physiotherapy, focusing on the treatment and prevention of physical injuries, disabilities, and disorders. Typically, it is a four-year program, although the duration may vary depending on the country and institution. During the BPT program, students study various aspects of human anatomy, physiology, biomechanics, kinesiology, and exercise therapy. They also learn about different physiotherapeutic techniques and modalities, including manual therapy, electrotherapy, hydrotherapy, and therapeutic exercise. The curriculum includes both theoretical coursework and practical clinical training, allowing students to develop the necessary knowledge and skills to assess, diagnose, plan, and implement treatment programs for individuals of all ages with musculoskeletal, neurological, cardiopulmonary, or other conditions. Upon completion of the BPT program, graduates are eligible to pursue licensure or registration to practice as physiotherapists in their respective jurisdictions. They may work in various settings, including hospitals, clinics, rehabilitation centers, sports facilities, schools, or community health centers, helping individuals restore movement and function, alleviate pain, and improve overall quality of life through physiotherapy interventions.",
        "image": "/static/images/BPT.jpg"
    },
    "BMLT": {
        "content": "A Bachelor of Medical Laboratory Technology (BMLT) is an undergraduate degree program that focuses on training students in various aspects of laboratory medicine and diagnostic techniques. Typically, it is a three to four-year program, though the duration may vary depending on the country and institution. During the BMLT program, students learn about different laboratory techniques, equipment, and procedures used in the analysis of biological samples such as blood, urine, tissue, and other bodily fluids. They study subjects like clinical biochemistry, microbiology, hematology, immunology, and histopathology, gaining theoretical knowledge and practical skills in laboratory testing, quality control, and interpretation of results. Upon completion of the BMLT program, graduates are qualified to work as medical laboratory technologists or technicians in various healthcare settings, including hospitals, diagnostic laboratories, research institutions, and public health agencies. They play a crucial role in disease diagnosis, monitoring treatment effectiveness, and ensuring the accuracy and reliability of laboratory test results, contributing to patient care and healthcare delivery.",
        "image": "/static/images/BMLT.jpg"
    },
    "MBBS": {
        "content": ' MBBS stands for Bachelor of Medicine, Bachelor of Surgery, which is an undergraduate degree program in the field of medicine. It typically spans five to six years, depending on the country and institution.  During the MBBS program, students undergo rigorous training in various medical disciplines, including anatomy, physiology, biochemistry, pharmacology, pathology, microbiology, and clinical medicine. The curriculum encompasses both theoretical learning and practical clinical experience, with students spending time in hospitals and clinics to gain hands-on training in patient care, diagnosis, and treatment. Upon completion of the MBBS program, graduates are awarded the qualification of "Doctor of Medicine" (MD) or "Bachelor of Medicine, Bachelor of Surgery" (MBBS), depending on the naming convention of their country or university. They are then eligible to pursue licensure or registration to practice medicine as a physician or surgeon in their respective jurisdictions. Many graduates choose to specialize further by undertaking postgraduate training in specific medical specialties through residency programs.',
        "image": "/static/images/MBBS.jpg"
    },
    "Medical Technician ": {
    "content": "Medical technicians play a crucial role in healthcare by assisting physicians and other medical professionals in diagnosing and treating patients. They perform various laboratory tests, analyze specimens, and operate medical equipment to help detect, diagnose, and monitor diseases and medical conditions. Medical technicians work in various settings, including hospitals, clinics, laboratories, and research facilities. They may specialize in areas such as clinical laboratory technology, radiologic technology, surgical technology, or cardiovascular technology. Becoming a medical technician typically requires completion of a formal training program, which may include obtaining an associate degree or certification in a specific area of medical technology. Additionally, medical technicians must possess strong analytical skills, attention to detail, and the ability to work well under pressure.",
    "image": "/static/images/technician.jpg"
    },

    "Error": {
        "content": "Sorry, Couldn't find any branch for your recommendations. Please try again sometime",
        "image": "/static/images/sorry.jpg"
    },
    "BCom(Hons)": {
